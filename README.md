...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   Semantic HTML are tags that provide meaning to both the browser and the developer.
2. What are the 4 areas of the box model?
   The four areas of the box model are content, padding, border, margin.
3. While using flexbox, what axis does the following property work on: `align-items: center`?
   Align items center works on the cross axis.
4. Explain why git is valuable to a team of developers.
   Git offers performance, functionality, security, and flexibility that most developers and teams need to develop projects.
5. Define mobile-first design in your own words.
   Mobile first design is basically designing a website at mobile screen size first, then designing for bigger screen sizes later on.  
